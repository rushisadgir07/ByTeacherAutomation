...
public class MultipleTrackExam {
	String examNa;
	String tMarks;
	String passMarks;
	String startda;
	...
	private WebElement batch2WebElement;
	...
	public MultipleTrackExam(WebDriver driver) throws FileNotFoundException, ParseException {
		this.driver = driver;
	...
	public void creatThreeTrack() throws InterruptedException {
		...
		// Thread.sleep(5000);
		// act.moveToElement(clickOnSchemeType).click().build().perform();
