...
public class MultiSubjectExam {
	...
	@FindBy(id = "2calculate0")
	private WebElement numPositiveMarkWebElement;
	@FindBy(id = "2getInstruction0")
	...
	public MultiSubjectExam(WebDriver driver) throws FileNotFoundException, ParseException {
		this.driver = driver;
	...
	public void filltrack() throws InterruptedException {
		...
		// unit2questionWebelement.sendKeys(numberques2);
		 unit3questionWebelement.sendKeys(numberques1);
		...
		Thread.sleep(1000);
		// unit1questionWebelement.sendKeys(numberques1);
		 unit2questionWebelement.sendKeys(numberques3);
		//unit3questionWebelement.sendKeys(numberques3);
		addQuestionWebelement.click();
		Thread.sleep(1500);
		selectquestionWebelement.click();
