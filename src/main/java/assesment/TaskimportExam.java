...
public class TaskimportExam {
	...
	private WebElement numericDeadlineWebElement;//Numeric track created successfully
	...
	@FindBy(xpath = "//input[@placeholder='Enter Task Id']")
	private WebElement enterTaskID;
	@FindBy(xpath = "//i[@class='fa fa-arrow-right fa-2x']")
	private WebElement idArrowWebElement;
	...
	public TaskimportExam(WebDriver driver) throws FileNotFoundException, ParseException {
		this.driver = driver;
	...
	public void filltrack() throws InterruptedException {
		...
		Thread.sleep(1000);
		enterTaskID.sendKeys("1022564");
		Thread.sleep(1000);
		act.click(idArrowWebElement).build().perform();
		Thread.sleep(1000);
		saveButtonWebElement.click();
		Thread.sleep(1500);
		act.moveToElement(lockTrackWebelement).click().build().perform();
