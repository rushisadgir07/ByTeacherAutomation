...
public class TransferCourse {
	...
	@FindBy(xpath = "//button[text()='Transfer Course']")
	private WebElement transferCourseWebElement;
	...
	public TransferCourse(WebDriver driver) {
	...
	public void transferCourse() throws InterruptedException {
		...
		Thread.sleep(500);
		transferCourseWebElement.click();
		Thread.sleep(500);
		ClickSecondCourseWebElement.click();
		selectNewCourseWebElement.click();
		clickonTransferWebElement.click();
		Thread.sleep(1500);
